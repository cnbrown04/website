  ...
  <div style={{ flex: '1', minWidth: '200px', paddingTop: '1.5rem' }}>
    <ul style={{ margin: 0, padding: 0, listStyle: 'none' }}>
      ...
      <li style={{ padding: '0.75rem 0', borderBottom: '1px solid #e7e5e4', display: 'flex', alignItems: 'baseline', gap: '0.5rem' }}>
        ...
        <span><strong style={{ color: '#1c1917' }}>Brocade ICX6450-48.</strong> 48-port switch. 48 1Gbps, 4 10Gbps.</span>
      </li>
      <li style={{ padding: '0.75rem 0', borderBottom: '1px solid #e7e5e4', display: 'flex', alignItems: 'baseline', gap: '0.5rem' }}>
...
- Swap R740 with SFF bays to the LFF version to use as the primary storage server.
- New node using Epyc 7002 or 7003 as the new VM host. 
- New 1u Ryzen server for high single core performance compute.